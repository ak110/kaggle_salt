...
mpirun -np $GPUS python3 train_2.py --cv-index=0
mpirun -np $GPUS python3 train_2.py --cv-index=1
mpirun -np $GPUS python3 train_2.py --cv-index=2
mpirun -np $GPUS python3 train_2.py --cv-index=3
mpirun -np $GPUS python3 train_2.py --cv-index=4
