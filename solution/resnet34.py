...
def _create_network():
    ...
    x = inputs[0]
    x = x_in = tk.dl.layers.pad2d()(((13, 14), (13, 14)), mode='reflect')(x)  # 128
    ...
    x = keras.layers.concatenate([
        tk.dl.layers.resize2d()((128, 128))(up_list[0]),
        tk.dl.layers.resize2d()((128, 128))(up_list[1]),
        tk.dl.layers.resize2d()((128, 128))(up_list[2]),
        tk.dl.layers.resize2d()((128, 128))(up_list[3]),
        tk.dl.layers.resize2d()((128, 128))(up_list[4]),
        up_list[5],
    ])  # 128
