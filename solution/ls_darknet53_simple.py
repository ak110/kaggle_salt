...
def _create_network():
    ...
    e1 = base_network.get_layer(name='add_1').output
    e2 = base_network.get_layer(name='add_3').output
    e3 = base_network.get_layer(name='add_11').output
    e4 = base_network.get_layer(name='add_19').output
    e5 = base_network.get_layer(name='add_23').output
    ...
    x = keras.layers.concatenate([
        keras.layers.UpSampling2D((112, 112))(x),  # center: 1
        tk.dl.layers.resize2d()((112, 112))(builder.conv2d(32, 1)(e5)),  # stage 5: 7
        tk.dl.layers.resize2d()((112, 112))(builder.conv2d(32, 1)(e4)),  # stage 4: 14
        tk.dl.layers.resize2d()((112, 112))(builder.conv2d(32, 1)(e3)),  # stage 3: 28
        tk.dl.layers.resize2d()((112, 112))(builder.conv2d(32, 1)(e2)),  # stage 2: 56
        builder.conv2d(32, 1)(e1),  # stage 1: 112
    ])
