...
def _train(args):
    ...
    model.compile(sgd_lr=0.01 / 128, loss='binary_crossentropy', metrics=[tk.dl.metrics.binary_accuracy])
...
def _create_network():
    ...
    base_model = keras.applications.InceptionResNetV2(include_top=False, input_tensor=x)
